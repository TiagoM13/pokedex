...
export const PokemonCard = ({
  ...
  return (
    <li
      style={{
        backgroundColor: types.type_1.toUpperCase() ? getTypesToColor(types.type_1.toUpperCase()) : '#121212'
      }}
    ...
    >
      <div className="py-2 px-1">
        <div className="flex flex-col">
          <h3 className="font-black line-clamp-1 text-sm">{`${name[0].toUpperCase() + name.substring(1)}`}</h3>
          <span className="font-semibold text-sm">{getNumberOrderFormat(order)}</span>
        </div>
